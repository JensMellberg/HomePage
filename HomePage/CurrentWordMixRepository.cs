...
namespace HomePage
{
    public class CurrentWordMixRepository : SingleRepository<CurrentWordMix>
    {
        public override string FileName => "CurrentWordMix.txt";
        ...
        public void Recreate(CurrentWordMix entity)
        {
            ...
            entity.CreatedDate = DateHelper.ToKey(DateHelper.DateNow);
            this.Save(entity);
